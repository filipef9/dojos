...
import me.fsn.filipe.refactoring.model.factories.CaminhoneteFactory;
...
public class CaminhoneteTest {

    private static final String MODELO = "FIAT/STRADA";
    ...
    private static final VeiculoFactory FABRICA_CAMINHONETE = new CaminhoneteFactory();
    ...
    @Test
    public void nao_deve_permitir_criacao_de_caminhonete_com_placa_nula() {
        try {
            veiculo = FABRICA_CAMINHONETE.criarVeiculo(PLACA_NULA, MODELO);
    ...
    @Test
    public void nao_deve_permitir_criacao_de_caminhonete_com_modelo_nulo() {
        try {
            veiculo = FABRICA_CAMINHONETE.criarVeiculo(PLACA, MODELO_NULO);
            fail(DEVERIA_TER_LANCADO_UMA_EXCECAO);
        } catch (NullPointerException e) {
